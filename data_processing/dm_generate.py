...
# df = pd.read_json(f'/home/qi/Projects/NER/ds_ner/out/rb_{dataset}_dm/dy_log/td_df.jsonl', lines=True)
...
thres = pos_fake_df.iloc[int(len(pos_fake_df)*0.1)]['confidence']
