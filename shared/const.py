...
task_ner_labels = {
    ...
    'webpage': ['ORG', 'MISC', 'PER', 'LOC'],
    'onto': ['WORK_OF_ART', 'PERSON', 'FAC', 'EVENT', 'LANGUAGE', 'ORDINAL', 'TIME', 'PRODUCT', 'DATE', 'CARDINAL', 'ORG', 'GPE', 'LAW', 'MONEY', 'PERCENT', 'LOC', 'QUANTITY', 'NORP'],
    'onto2': ['WORK_OF_ART', 'PERSON', 'FAC', 'EVENT', 'LANGUAGE', 'ORDINAL', 'TIME', 'PRODUCT', 'DATE', 'CARDINAL', 'ORG', 'GPE', 'LAW', 'MONEY', 'PERCENT', 'LOC', 'QUANTITY', 'NORP']
}
